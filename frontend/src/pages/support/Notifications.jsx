...
async function runFirstSuccessful(requests) {
  let lastError = null;
      ...
      try {
        const response =
          await runFirstSuccessful([
            ...
            () =>
              api.get(
                "/notifications?recipientRole=support"
              ),
            () =>
              api.get(
      ...
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>
            Заявки организаций, обращения и системные сообщения.
          </p>
        </div>
