...
export default function DoctorNotifications() {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Уведомления врача</h2>
      <p style={styles.sub}>Уведомления о записях, переносах и отмене приемов.</p>
          ...
          {notifications.length === 0 ? (
            <div style={styles.item}>
              ...
              <div>
                ...
                <p style={{ margin: 0, color: "#94a3b8", fontSize: "14px" }}>Входящие оповещения появятся здесь.</p>
              </div>
            </div>
          ) : (
            notifications.map((n) => (
