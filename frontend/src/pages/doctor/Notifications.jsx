...
const TEXTS = {
  ru: {
    pageTitle: "Уведомления врача",
    pageSubtitle:
      "Новые записи, изменения расписания и системные сообщения.",
  ...
  kk: {
    pageTitle: "Дәрігер хабарландырулары",
    pageSubtitle:
      "Жаңа жазылулар, кесте өзгерістері және жүйелік хабарламалар.",
